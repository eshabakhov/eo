...
```text
to-java.xsl              58506  34.46%
classes.xsl              55626  32.77%
set-locators.xsl         14015  8.26%
set-original-names.xsl   9834   5.79%
attrs.xsl                8153   4.80%
data.xsl                 7119   4.19%
tests.xsl                5607   3.30%
anonymous-to-nested.xsl  5533   3.26%
package.xsl              5366   3.16%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-03-30 at 11:15,
on Linux with 4 CPUs.
The total is 169759 milliseconds.
...
[benchmark-gha]: https://github.com/eshabakhov/eo/actions/runs/23741706452
