...
```text
to-java.xsl              57700  33.57%
classes.xsl              56706  32.99%
set-locators.xsl         14014  8.15%
set-original-names.xsl   9796   5.70%
attrs.xsl                8570   4.99%
data.xsl                 7544   4.39%
anonymous-to-nested.xsl  5951   3.46%
tests.xsl                5816   3.38%
package.xsl              5767   3.36%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-03-30 at 04:30,
on Linux with 4 CPUs.
The total is 171864 milliseconds.
...
[benchmark-gha]: https://github.com/eshabakhov/eo/actions/runs/23727826770
